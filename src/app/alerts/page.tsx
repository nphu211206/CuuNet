              ...
              <div className="p-4 rounded-xl bg-red-500/5 border border-red-500/15">
                <div className="flex items-center justify-between">
                  ...
                  <motion.button
                    ...
                    className="relative px-6 py-3 rounded-xl font-bold text-sm bg-red-600 text-white hover:bg-red-500 shadow-lg shadow-red-500/30 transition-all duration-200"
                  >
