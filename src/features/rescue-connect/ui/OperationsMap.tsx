          ...
          >
            <div className="p-3 border-b border-slate-700/30">
              <div className="flex items-center justify-between">
                <h3 className="text-xs font-semibold text-slate-200">Lớp bản đồ</h3>
                <button
...
function MapLegend() {
  return (
    <div className="absolute bottom-3 left-3 z-[1000]">
      <div className="bg-slate-900/80 backdrop-blur-xl rounded-xl border border-slate-700/50 p-3">
        <h4 className="text-[10px] font-semibold text-slate-400 mb-2">Chú giải</h4>
        <div className="space-y-1.5">
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full bg-red-500" />
            <span className="text-[10px] text-slate-400">Sự cố P1</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full bg-orange-500" />
            <span className="text-[10px] text-slate-400">Sự cố P2</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full bg-yellow-500" />
            <span className="text-[10px] text-slate-400">Sự cố P3</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full bg-green-500" />
            <span className="text-[10px] text-slate-400">Sự cố P4</span>
          </div>
          <div className="border-t border-slate-700/30 pt-1.5 mt-1.5">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] text-slate-400">Tài nguyên</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded bg-cyan-500" />
              <span className="text-[10px] text-slate-400">Nơi trú ẩn</span>
            </div>
          </div>
        </div>
      </div>
...
function MapZoomControls() {
  ...
  return (
    <div className="absolute top-3 left-3 z-[1000] flex flex-col gap-1">
      <button
        onClick={() => map.zoomIn()}
        className="w-8 h-8 rounded-lg bg-slate-900/80 backdrop-blur-xl border border-slate-700/50 flex items-center justify-center hover:border-slate-600/60 transition-colors"
      >
