  ...
  return (
    <motion.div
      ...
      className={clsx(
        ...
        isCenter
          ? "bg-slate-800/60 border-slate-600/50 min-w-[200px]"
          : "bg-slate-900/40 border-slate-700/30 hover:border-slate-600/50 min-w-[160px]"
      )}
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-1">
        ...
        <div>
          <h4 className="text-[10px] font-semibold text-slate-200">{titleVi}</h4>
      ...
      {/* Person info */}
      {person ? (
        <div className="mt-1.5 p-2 rounded-lg bg-slate-800/30 border border-slate-700/20">
          <div className="flex items-center gap-1.5">
            <User className="w-3 h-3 text-slate-400" />
            <span className="text-[11px] font-medium text-slate-200">{person.name}</span>
          </div>
          ...
          {person.phone && (
            <div className="flex items-center gap-1.5 mt-0.5">
              ...
              <span className="text-[10px] text-slate-400">{person.phone}</span>
            </div>
          )}
        </div>
      ) : (
        <div className="mt-1.5 p-2 rounded-lg bg-slate-800/20 border border-dashed border-slate-700/30 text-center">
    ...
    <div className={clsx("space-y-4", className)}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-semibold text-slate-200">Sơ đồ chỉ huy ICS</h3>
