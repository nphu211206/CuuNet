    ...
    >
      ...
      <AnimatePresence>
        {isExpanded && (
          ...
          >
            <div className="px-3.5 pb-3.5 space-y-3 border-t border-slate-200 pt-3">
              {/* Status Tracker */}
              ...
              <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-200">
                ...
                <div className="grid grid-cols-2 gap-2 text-[10px]">
                  ...
                  <div>
                    ...
                    <span className="text-slate-700">±{sos.location.accuracy}m</span>
                  </div>
                  {sos.location.address && (
                    <div className="col-span-2">
                      <span className="text-slate-600">Địa chỉ:</span>{" "}
                      <span className="text-slate-700">{sos.location.address}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              {(sos.contact.name || sos.contact.phone) && (
                <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-200">
                  ...
                  <div className="space-y-0.5 text-[10px]">
                    ...
                    {sos.contact.phone && (
                      <p className="text-slate-700">📞 {sos.contact.phone}</p>
                    )}
                  </div>
                </div>
              )}
