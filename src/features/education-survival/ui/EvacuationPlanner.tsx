...
function EmergencyContactCard({
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <span className="text-xs font-medium text-slate-800">{contact.name}</span>
        <div className="flex items-center gap-2 text-[10px] text-slate-500">
    ...
    <div className="flex items-center gap-3 p-3 rounded-xl bg-white border border-slate-200">
      ...
      <div className="flex-1">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium text-slate-800">{point.nameVi}</span>
        </div>
    ...
    <div className={clsx("space-y-4", className)}>
      ...
      <div className="p-3 rounded-xl bg-white border border-slate-200">
        ...
        <input
          ...
          className="w-full bg-slate-100 border border-slate-200 rounded-lg px-3 py-2 text-xs text-slate-800 placeholder:text-slate-600 focus:outline-none focus:border-blue-500/50"
        />
      </div>
      ...
      <div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-1.5 py-2 rounded-lg bg-slate-100 border border-slate-200 text-slate-500 text-[11px] font-medium hover:border-slate-300 transition-colors"
        >
      ...
      <div className="p-3 rounded-xl bg-white border border-slate-200">
        ...
        <textarea
          ...
          rows={3}
          className="w-full bg-slate-100 border border-slate-200 rounded-lg px-3 py-2 text-xs text-slate-800 placeholder:text-slate-600 focus:outline-none focus:border-blue-500/50 resize-none"
        />
      </div>
        ...
        <div className="space-y-1">
          {checklist.map((item, i) => (
            <div key={i} className="flex items-center gap-2">
              ...
              <span className={clsx("text-[11px]", item.done ? "text-green-400" : "text-slate-500")}>
                {item.label}
              </span>
            </div>
          ))}
