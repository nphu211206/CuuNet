        ...
        <>
          ...
          {reports.length > 5 && (
            <button
              ...
              className="w-full flex items-center justify-center gap-1 px-4 py-2.5 text-xs text-slate-500 hover:text-slate-700 hover:bg-slate-50 transition-colors"
            >
              {showAll ? (
                <>
                  Thu gọn
  ...
  return (
    <div className="flex items-center justify-between p-4 border-b border-slate-200">
      <div className="flex items-center gap-2">
        ...
        {count > 0 && (
          <span className="inline-flex items-center justify-center px-1.5 py-0.5 rounded-full text-[10px] font-bold bg-slate-700/50 text-slate-500">
            {count}
          </span>
        )}
      </div>
  ...
  return (
    <div className="grid grid-cols-2 gap-2 p-3 border-b border-slate-200">
      ...
      <div className="flex items-center gap-2 px-2 py-1.5 rounded-lg bg-slate-50">
        ...
        <div>
          <p className="text-xs font-semibold text-slate-700">{stats.total}</p>
  ...
  return (
    ...
    >
      <button
        ...
        className="w-full flex items-start gap-2.5 px-4 py-3 hover:bg-slate-50 transition-colors text-left"
      >
        {/* Type icon */}
        <span
        ...
        <div className="flex-1 min-w-0">
          {/* Title */}
          <h4 className="text-xs font-medium text-slate-700 truncate leading-tight">
            {report.title}
          </h4>
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              className="absolute right-0 top-full mt-1 z-10 w-32 py-1 rounded-lg bg-slate-200 border border-slate-200 shadow-xl"
            >
              <button
                onClick={(e) => {
                  e.stopPropagation();
                ...
                className="w-full flex items-center gap-2 px-3 py-1.5 text-xs text-slate-500 hover:bg-slate-200 hover:text-slate-700 transition-colors"
              >
...
function MyReportsEmpty({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-8 px-4">
      ...
      <p className="text-sm text-slate-500 mb-1">Chưa có báo cáo nào</p>
